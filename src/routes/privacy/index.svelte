...
<svelte:head>
	<title>Privacy Policy - Echopig</title>
</svelte:head>

<div class="content">
  <h1 class="is-size-1">Privacy Policy for Echopig</h1>

  <p>
    At Echopig, accessible from <a href="/">https://www.echopig.com</a>, one of
    ...
    Echopig and how we use it.
  </p>

  <p>
    If you have additional questions or require more information about our Privacy
    Policy, do not hesitate to contact us through email at
    <a href="mailto:privacy@echopig.com">privacy@echopig.com</a>
  </p>

  <h2 class="is-size-4">General Data Protection Regulation (GDPR)</h2>
  <p>We are a Data Controller of your information.</p>

  <p>
    Echopig's legal basis for collecting and using the personal information
  ...
  <ul>
    <li>Echopig needs to perform a contract with you</li>
    <li>You have given Echopig permission to do so</li>
    <li>
      Processing your personal information is in Echopig's legitimate interests
    </li>
    <li>Echopig needs to comply with the law</li>
  </ul>

  <p>
    Echopig will retain your personal information only for as long as is necessary
  ...
  <h2 class="is-size-4">Log Files</h2>

  <p>
    Echopig follows a standard procedure of using log files. These files log
    visitors when they visit websites. The information collected by log files
    include internet protocol (IP) addresses, browser type, date and time stamp,
    ...
    information is for analyzing trends, administering the site, tracking use of
    the website, and gathering demographic information.
  </p>

  <h2 class="is-size-4">Cookies and Web Beacons</h2>

  <p>
    Like other websites, Echopig uses 'cookies'. These cookies are used to store
  ...
  <h2 class="is-size-4">Privacy Policies</h2>

  <p>
    You may consult this list to find the Privacy Policy for each of the
    advertising partners of Echopig.
  </p>

  <p>
    Third-party ad servers or ad networks uses technologies like cookies,
    JavaScript, or Web Beacons that are used in their respective advertisements
    and links that appear on Echopig, which are sent directly to users' browser.
  ...
  <p>
    Note that Echopig has no access to or control over these cookies that are used
    by third-party advertisers.
  </p>

  <h2 class="is-size-4">Third Pary Privacy Policies</h2>

  <p>
    Echopig's Privacy Policy does not apply to other advertisers or websites.
    ...
    find a complete list of these Privacy Policies and their links here: Privacy
    Policy Links.
  </p>
  ...
  <h2 class="is-size-4">Children's Information</h2>
  ...
  <p>
    Echopig does not knowingly collect any Personal Identifiable Information from
  ...
  <h2 class="is-size-4">Online Privacy Policy Only</h2>

  <p>
    Our Privacy Policy applies only to our online activities and is valid for
    visitors to our website with regards to the information that they shared
    and/or collect in Echopig. This policy is not applicable to any information
    collected offline or via channels other than this website.
  </p>
  <p>
    Our GDPR Privacy Policy was generated from the
    <a href="https://gdprprivacypolicy.net">GDPR Privacy Policy Generator</a>.
  </p>

  <h2 class="is-size-4">Consent</h2>
